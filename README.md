...
Roles are marked for priest, deacon, people, choir, and reader. Where no deacon is serving, the priest says the deacon’s parts. The priest wears a bell-shaped brocade phelonion, open at the front, over a sleeved sticharion, with the epitrachelion down the chest, a beard, and a kamilavka. The deacon wears a brocade sticharion and an orarion draped over the left shoulder, and swings a censer during the censing. The reader and altar servers wear cassocks. A cantor stands at the kliros with the choir, beside a stand of books. The faithful are separate CC0 MakeHuman bodies: men and women, a child girl and boy, and a babushka in a headscarf (see [ATTRIBUTION.md](ATTRIBUTION.md)), with hair, eyebrows, eyes, and fitted clothes. They cross themselves at the Trisagion, the Creed, and the epiklesis. Processions play the walk clip. The icon panel closes when the step or the view mode changes. The notes for each step stay collapsed until you open them, and the top bar sits above the church so the step list remains visible.
