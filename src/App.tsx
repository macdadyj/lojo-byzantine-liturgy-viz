      ...
      <header className="info-bar">
        <div className="info-brand">
          ...
          <details className="about">
            ...
            <p>
              The church is a teaching model of a large nave. The icons are public-domain historical
              works listed in ATTRIBUTION.md. As you face the iconostas, the Theotokos is at the left
